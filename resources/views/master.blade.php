...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	...
	<!--//tags -->
	<link href="{{asset('lib/css/bootstrap.css')}}" rel="stylesheet" type="text/css" media="all" />
	...
	<!--//pop-up-box-->
	<!-- price range -->
	<link rel="stylesheet" type="text/css" href="{{asset('lib/css/jquery-ui1.css')}}">
	<!-- fonts -->
	<link href="{{asset('lib///fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i,800')}}" rel="stylesheet">
</head>
...
<body>
		...
		<div class="header-bot_inner_wthreeinfo_header_mid">
			...
			<div class="col-md-4 logo_agile">
				<h1>
					<a href="index.html">
						<span>G</span>rocery
						<span>S</span>hoppy
						<img src="{{asset('lib/images/logo2.png')}}" alt=" ">
					</a>
				</h1>
			</div>
			<!-- header-bot -->
			<div class="col-md-8 header">
				...
				<ul>
					...
					<li>
						<a href="{{url('/register')}}" data-toggle="modal" data-target="#myModal2">
				...
				<div class="top_nav_right">
					<div class="wthreecartaits wthreecartaits2 cart cart box_1">
								...
								<a href="{{url('/cart')}}"><button type="submit" class="btn btn-danger btn-lg"><i class="fa fa-cart-arrow-down fa-lg" aria-hidden="true"></i></button></a>
							...
							<ul class="nav navbar-nav menu__list">
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu agile_short_dropdown">
										<li>
											<a href="{{asset('lib/icons.html')}}">Web Icons</a>
										</li>
										<li>
		...
		<div class="container">
			...
			<div class="footer-info w3-agileits-info">
				...
				<div class="col-sm-2 footer-grids  w3l-socialmk">
					...
					<div class="agileits_app-devices">
						...
						<a href="#">
							<img src="{{asset('lib/images/1.png')}}" alt="">
						</a>
						<a href="#">
							<img src="{{asset('lib/images/2.png')}}" alt="">
						</a>
						<div class="clearfix"> </div>
					</div>
				</div>
			...
			<div class="agile-sometext">
				...
				<div class="sub-some child-momu">
					...
					<ul>
						<li>
							<img src="{{asset('lib/images/pay2.png')}}" alt="">
						</li>
						<li>
							<img src="{{asset('lib/images/pay5.png')}}" alt="">
						</li>
						<li>
							<img src="{{asset('lib/images/pay1.png')}}" alt="">
						</li>
						<li>
							<img src="{{asset('lib/images/pay4.png')}}" alt="">
						</li>
						<li>
							<img src="{{asset('lib/images/pay6.png')}}" alt="">
						</li>
						<li>
							<img src="{{asset('lib/images/pay3.png')}}" alt="">
						</li>
						<li>
							<img src="{{asset('lib/images/pay7.png')}}" alt="">
						</li>
						<li>
							<img src="{{asset('lib/images/pay8.png')}}" alt="">
						</li>
						<li>
							<img src="{{asset('lib/images/pay9.png')}}" alt="">
						</li>
					</ul>
				</div>
				<!-- //payment -->
	...
	<div class="copy-right">
		<div class="container">
			<p>© 2020 Grocery Shoppy. All rights reserved | Design
				<a href="#"> </a>
			</p>
		</div>
	</div>
	...
	<script src="{{asset('lib/js/jquery.magnific-popup.js')}}"></script>
	<script>
	...
	<!-- cart-js -->
	<script src="{{asset('lib/js/minicart.js')}}"></script>
	<script>
	...
	<script src="{{asset('lib/js/jquery.flexisel.js')}}"></script>
	<script>
		$(window).load(function () {
	...
	<!-- smoothscroll -->
	<script src="{{asset('lib/js/SmoothScroll.min.js')}}"></script>
	<!-- //smoothscroll -->

	<!-- start-smooth-scrolling -->
	<script src="{{asset('lib/js/move-top.js')}}"></script>
	<script src="{{asset('lib/js/easing.js')}}"></script>
	<script>
