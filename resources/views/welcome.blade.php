                ...
                <div class="deal-leftmk left-side">
                    ...
                    <div class="special-sec1">
                        <div class="col-xs-4 img-deals">
                            <img src="{{asset('lib/images/d2.jpg')}}" alt="">
                        </div>
                    ...
                    <div class="special-sec1">
                        ...
                        <div class="col-xs-4 img-deals">
                           <img src="{{asset('uploads/'.$product->thum_img)}}"style="height: 80px" alt="">
                        </div>
                        <div class="col-xs-8 img-deal1">
                            <h3>{{$product->name}}</h3>
                            <a href="{{url('product-details-'.$product->id)}}">${{$product->price}}</a>
                        </div>
                        <div class="clearfix"></div>
                        @endforeach
                    </div>
                    <div class="special-sec1">
                        <div class="col-xs-4 img-deals">
                            <img src="{{asset('lib/images/d4.jpg')}}" alt="">
                        </div>
                        <div class="col-xs-8 img-deal1">
                            <h3>Tata Salt</h3>
                    ...
                    <div class="special-sec1">
                        <div class="col-xs-4 img-deals">
                            <img src="{{asset('lib/images/d5.jpg')}}" alt="">
                        </div>
                        <div class="col-xs-8 img-deal1">
                    ...
                    <div class="special-sec1">
                        <div class="col-xs-4 img-deals">
                            <img src="{{asset('lib/images/d3.jpg')}}" alt="">
                        </div>
                        <div class="col-xs-8 img-deal1">
                ...
                <div class="wrapper">
                    ...
                    <div class="product-sec1">
                        ...
                        <div class="col-md-4 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img src="{{asset('lib/images/m1.jpg')}}" alt="">
                        ...
                        <div class="col-md-4 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img src="{{asset('lib/images/m3.jpg')}}" alt="">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="single.html" class="link-product-add-cart">Quick View</a>
                                        </div>
                    ...
                    <div class="product-sec1">
                        ...
                        <div class="col-md-4 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img src="{{asset('lib/images/mk4.jpg')}}" alt="">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="single.html" class="link-product-add-cart">Quick View</a>
                                        </div>
                        ...
                        <div class="col-md-4 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img src="{{asset('lib/images/mk5.jpg')}}" alt="">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="single.html" class="link-product-add-cart">Quick View</a>
                                        </div>
                        ...
                        <div class="col-md-4 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img src="{{asset('lib/images/mk6.jpg')}}" alt="">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="single.html" class="link-product-add-cart">Quick View</a>
                                        </div>
                    ...
                    <div class="product-sec1">
                        ...
                        <div class="col-md-4 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img src="{{asset('lib/images/mk7.jpg')}}" alt="">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="single.html" class="link-product-add-cart">Quick View</a>
                                        </div>
                        ...
                        <div class="col-md-4 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img src="{{asset('lib/images/mk8.jpg')}}" alt="">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="single.html" class="link-product-add-cart">Quick View</a>
                                        </div>
                        ...
                        <div class="col-md-4 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img src="{{asset('lib/images/mk9.jpg')}}" alt="">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="single.html" class="link-product-add-cart">Quick View</a>
                                        </div>
